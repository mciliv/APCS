...
public class Main
{
	...
	public static Location randomly(ArrayList<Location> list, Grid grid)
	{
		...
		while (checker ==1)
		{
			...
			c = (int) (Math.random()*grid.getNumCols());
			newLoc = new Location(r,c);


			for (int i = 0; i<list.size(); i++)
			{
				if ((list.get(i)).equals(newLoc))
				{
					checker=1;
				}
			}
