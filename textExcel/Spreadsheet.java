...
public class Spreadsheet implements Grid
{
	...
	//TODO: replace with getCell method
...
//							char lastp = (theText.charAt(theText.length()-1));
							...
							if (first=='(' && last==')') //FORMULA CELL
							{
								spreadsheet[theLocation2.getRow()][theLocation2.getCol()] = new FormulaCell(theText, this);
